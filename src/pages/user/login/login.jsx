// import YihoDropWown from '../../../components/DropDown/index'
...
function Login() {
    ...
    return (
        <div style={{'width':'356px'}}>
            <DropDownInput region={temp}></DropDownInput>
            <div className='login-title'>
                <span>未注册的手机号验证后将自动创建小米帐号</span>
            </div>
            <div className=' mt-5'>
                <div style={{'display':'flex',alignItems:'center'}}>
                    <div>
                        <div onClick={handleRadio} className={isRadio?'radio radio-active':'radio'}></div>
                    </div>
                    <div className=' ml-1' style={{'color':'#aaa',fontSize:'14px'}}>
                        <span>已阅读并同意小米帐号</span>
                        <span style={{color:"#333"}} className=" ml-1 mr-1">用户协议</span>
                        <span>和</span>
                        <span style={{color:'#333'}} className=" ml-1">隐私政策</span>
                    </div>
                </div>
            </div>
